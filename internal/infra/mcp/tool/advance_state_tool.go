...
func (t *AdvanceStateTool) CreateOrder(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	execLayerData := fmt.Sprintf(`{"path":"order/create","data":{"crowdfunding_id":%s,"interest_rate":"%s"}}`, crowdfundingId, interestRate)
...
// func (t *AdvanceStateTool) CreateCrowdfunding(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
// 	}
// 	execLayerData := fmt.Sprintf(`{"path":"crowdfunding/create","data":%s}`, string(inputBytes))
// 	execLayerDataBytes := []byte(execLayerData)
// 	amountBig := new(big.Int)
// 	amountBig.SetString(amount, 10)
// 	receipt, err := ethutil.ERC20Deposit(ctx, t.Client, t.TxOpts, t.PortalAddress, t.TokenAddress, t.AppAddress, amountBig, execLayerDataBytes)
...
// func (t *AdvanceStateTool) CloseCrowdfunding(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
// 	crowdfundingId, ok := request.Params.Arguments["crowdfunding_id"].(float64)
// 	if !ok {
// 		return mcp.NewToolResultError("crowdfunding_id must be a number"), nil
// 	}
// 	input := map[string]interface{}{
// 		"crowdfunding_id": uint(crowdfundingId),
// 	}
// 	inputBytes, err := json.Marshal(input)
// 	if err != nil {
// 		return mcp.NewToolResultError("failed to marshal input"), nil
...
// func (t *AdvanceStateTool) SettleCrowdfunding(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
// 	crowdfundingId, ok := request.Params.Arguments["crowdfunding_id"].(float64)
// 	if !ok {
// 		return mcp.NewToolResultError("crowdfunding_id must be a number"), nil
// 	}
...
// func (t *AdvanceStateTool) UpdateCrowdfunding(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
// 	crowdfundingId, ok := request.Params.Arguments["crowdfunding_id"].(float64)
// 	if !ok {
// 		return mcp.NewToolResultError("crowdfunding_id must be a number"), nil
// 	}
...
// func (t *AdvanceStateTool) DeleteCrowdfunding(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
// 	crowdfundingId, ok := request.Params.Arguments["crowdfunding_id"].(float64)
// 	if !ok {
// 		return mcp.NewToolResultError("crowdfunding_id must be a number"), nil
// 	}
