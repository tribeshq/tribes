...
type ContractRepository interface {
	...
	FindContractByAddress(ctx context.Context, address custom_type.Address) (*entity.Contract, error)
...
type CrowdfundingRepository interface {
	...
	FindCrowdfundingsByCreator(ctx context.Context, creator custom_type.Address) ([]*entity.Crowdfunding, error)
	FindCrowdfundingsByInvestor(ctx context.Context, investor custom_type.Address) ([]*entity.Crowdfunding, error)
