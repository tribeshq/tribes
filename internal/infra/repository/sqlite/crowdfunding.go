...
func (r *SQLiteRepository) FindCrowdfundingsByInvestor(ctx context.Context, investor Address) ([]*entity.Crowdfunding, error) {
	var crowdfundings []*entity.Crowdfunding
	if err := r.Db.WithContext(ctx).
...
func (r *SQLiteRepository) FindCrowdfundingsByCreator(ctx context.Context, creator Address) ([]*entity.Crowdfunding, error) {
	var crowdfundings []*entity.Crowdfunding
	if err := r.Db.WithContext(ctx).
