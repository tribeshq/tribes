...
func (r *SQLiteRepository) FindUserByAddress(ctx context.Context, address type.Address) (*entity.User, error) {
...
func (r *SQLiteRepository) DeleteUser(ctx context.Context, address type.Address) error {
