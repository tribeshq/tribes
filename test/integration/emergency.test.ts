...
import { safeEmergencyWithdrawAbi } from '../../contracts'

const ADMIN_ADDRESS = getAddress('0xD554153658E8D466428Fa48487f5aba18dF5E628')

const EMERGENCY_WITHDRAW_ADDRESS = getAddress('0x0000000000000000000000000000000000000006')
...
describe('Emergency Tests', () => {
  ...
  it('should emergency erc20 withdraw', () => {
    ...
    const delegateCallPayload = encodeFunctionData({
      abi: safeEmergencyWithdrawAbi,
      functionName: 'safeEmergencyERC20Withdraw',
      args: [token, to],
    })
  ...
  it('should emergency ether withdraw', () => {
    ...
    const delegateCallPayload = encodeFunctionData({
      abi: safeEmergencyWithdrawAbi,
      functionName: 'safeEmergencyETHWithdraw',
      args: [to],
    })
    const expectedOutput = encodeDelegateCallVoucherOutput({
      destination: EMERGENCY_WITHDRAW_ADDRESS,
